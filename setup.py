...
# *************** Dependencies *********
INSTALL_REQUIRES = ['pathlib2;python_version<"3.2"', 'makefun;python_version<"3.6"']
DEPENDENCY_LINKS = []
...
# ************** ID card *****************
DISTNAME = 'fprules'
DESCRIPTION = '`make`-like file pattern rules for build tools such as `doit`.'
...
KEYWORDS = 'file pattern rules GNU make build tool task'
